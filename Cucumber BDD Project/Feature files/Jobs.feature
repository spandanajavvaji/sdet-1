...
Feature: Alchemy Job-board system scenarios
  ...
  Scenario: Post a job using parameterization
    ...
    And Enter Application email as "test2107@gmail.com" and company as "IBM"
  ...
  Scenario Outline: Post a job using parameterization
   ...
   # And Close the browser
    ...
    Examples: 
      ...
      | charlie17@gmail.com 	|FullstackTester31  	| Description15     | tech14@gmail.com   |	IBM			|
    	| charlie27@gmail.com 	|FullStackTesters41 	| Jobdescription16  | test15@gmail.com   |	IBM			|